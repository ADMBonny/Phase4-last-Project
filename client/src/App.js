        ...
        <nav className="bg-white p-6 shadow-md">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div className="flex space-x-4">
              ...
              <Link to="/signup" className="text-lg font-semibold text-purple-600 py-2 px-4 rounded hover:bg-purple-100 transition duration-300 ease-in-out">Signup</Link>
            </div>
            <h1 className="text-gray-800 text-3xl font-bold">Event Management System</h1>
          </div>
        </nav>
        <div className="max-w-7xl mx-auto px-4 py-8">
          {/* Rendering Routes */}
          <Routes>
            <Route path="/" element={<EventList events={events} />} exact />
            ...
            {/* Render SignupForm and pass handleSignupSuccess function */}
            <Route path="/signup" element={<SignupForm onSignup={handleSignupSuccess} />} />
          </Routes>
        </div>
      </div>
    </BrowserRouter>
